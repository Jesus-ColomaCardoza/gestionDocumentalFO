...
type MovimientoCreateOrUpdateProps = {
  submitted: boolean;
  ...
  loadingMovimientoCreateOrUpdate: boolean;
...
const MovimientoCreateOrUpdate = (props: MovimientoCreateOrUpdateProps) => {
  ...
  const movimientoDialogFooter = (
    <>
      ...
      />
      <Button
        loading={props.loadingMovimientoCreateOrUpdate}
        label="Aceptar"
        icon="pi pi-check"
        onClick={
          props.movimientoDialog.type == "create"
            ? props.createMovimiento
            : props.updateMovimiento
        }
      />
    </>
  );
  ...
  return (
    <Dialog
      visible={props.movimientoDialog.state}
      style={{ width: "40rem" }}
      breakpoints={{ "960px": "75vw", "641px": "90vw" }}
      header="Movimiento"
      modal
      className="p-fluid"
      footer={movimientoDialogFooter}
...
export default MovimientoCreateOrUpdate;
